mixdiri.contour <- function(a, prob, n = 100, x = NULL, cont.line = FALSE) {
  ...
  can <- Compositional::dmixdiri(wa, a, prob, logged = FALSE)
                  ...
                  # Adjust axes to points
                   plot.axes = {
                       ...
                       if ( !is.null(x) ) {
                          ...
                          # Show corner titles
                           text( b[1, 1], b[1, 2] + 0.05, nam[3], cex = 1, col = "black", font = 2 );
                           text( b[2:3, 1], b[2:3, 2] - 0.04, nam[1:2], cex = 1, col = "black", font = 2 );
                           # Add contour lines
                               if ( cont.line ) {
                                 contour(x1, x2, mat,
                                         pt = "s",
